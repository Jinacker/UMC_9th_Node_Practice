...
import { checkOngoingMission, addMissionClearLog, getMissionClearLogById, getMyMissionListRepo, checkMissionProgress, patchCompleteMission, checkUser } from "./user-mission.repository.js";
export const challengeMission = async (dinerMissionId, userId, data) => {
    // 1. 이미 도전 중인 미션인지 확인
...
export const myMissionListService = async (userId, cursor) => {
    // 내 진행중인 미션 목록 조회
...
export const completeMissionService = async (userId, missionLogId) => {
